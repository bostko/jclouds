...
import static org.jclouds.aws.lambda.reference.AWSEC2Constants.PROPERTY_EC2_CC_REGIONS;
...
public class AWSLambdaProviderMetadata extends BaseProviderMetadata {
   ...
   public AWSLambdaProviderMetadata() {
      super(builder());
   }

   public AWSLambdaProviderMetadata(Builder builder) {
      super(builder);
   }
   ...
   public static class Builder extends BaseProviderMetadata.Builder {
      ...
      @Override
      public AWSLambdaProviderMetadata build() {
         return new AWSLambdaProviderMetadata(this);
      }
