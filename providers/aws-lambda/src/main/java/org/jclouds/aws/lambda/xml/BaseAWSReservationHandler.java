 ...
 */
package org.jclouds.aws.lambda.xml;
...
import org.jclouds.aws.lambda.domain.MonitoringState;
...
public abstract class BaseAWSReservationHandler<T> extends HandlerForGeneratedRequestWithResult<T> {
   ...
   protected FunctionCode.Builder builder = newBuilder();

   protected FunctionCode.Builder newBuilder() {
